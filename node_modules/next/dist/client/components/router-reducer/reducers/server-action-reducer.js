...
function serverActionReducer(state, action) {
    ...
    if (redirectLocation) {
        ...
        if (actionFlightData) {
            const href = (0, _createhreffromurl.createHrefFromUrl)(redirectLocation, // Ensures the hash is not part of the cache key as it does not affect fetching the server
            false);
