...
import { RSC, RSC_VARY_HEADER, FLIGHT_PARAMETERS } from "../client/components/app-router-headers";
...
export default class Server {
    constructor(options){
        ...
        this.clientReferenceManifest = serverComponents ? this.getServerComponentManifest() : undefined;
   ...
   */ async prepare() {
    ...
    async runImpl(req, res, parsedUrl) {
        ...
        if (!globalThis.__incrementalCache && !getRequestMeta(req, "_nextIncrementalCache")) {
            let protocol = "https:";
            try {
    ...
    async renderToResponseWithComponentsImpl({ req , res , pathname , renderOpts: opts  }, { components , query  }) {
        ...
        const isFlightRequest = Boolean(this.clientReferenceManifest && req.headers[RSC.toLowerCase()]);
        ...
        const doRender = async ()=>{
            ...
            const match = pathname !== "/_error" && !is404Page && !is500Page ? getRequestMeta(req, "_nextMatch") : undefined;
            if (match) {
                const context = {
                    params: match.params,
                ...
                try {
                    ...
                    if (response) {
                        ...
                        if (isSSG && process.env.NEXT_RUNTIME !== "edge") {
                            ...
                            let revalidate = (_context_staticGenerationContext_store = context.staticGenerationContext.store) == null ? void 0 : _context_staticGenerationContext_store.revalidate;
