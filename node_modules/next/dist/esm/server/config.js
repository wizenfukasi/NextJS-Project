...
function assignDefaults(dir, userConfig, silent = false) {
    var _result_experimental, _result_experimental1, _result_experimental2, _result_experimental3, _result_devIndicators;
    ...
    if (((_result_experimental2 = result.experimental) == null ? void 0 : _result_experimental2.outputFileTracingRoot) && !isAbsolute(result.experimental.outputFileTracingRoot)) {
    ...
    if (!((_result_experimental3 = result.experimental) == null ? void 0 : _result_experimental3.outputFileTracingRoot)) {
        const lockFiles = [
            "package-lock.json",
            "yarn.lock",
            "pnpm-lock.yaml"
