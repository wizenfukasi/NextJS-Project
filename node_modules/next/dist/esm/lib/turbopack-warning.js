...
export async function validateTurboNextConfig({ dir , isCustomTurbopack , isDev  }) {
    ...
    let rawNextConfig = {};
    try {
        rawNextConfig = interopDefault(await loadConfig(PHASE_DEVELOPMENT_SERVER, dir, undefined, true));
