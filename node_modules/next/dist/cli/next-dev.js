...
const nextDev = async (argv)=>{
    ...
    if (args["--turbo"]) {
        var _rawNextConfig_experimental, _rawNextConfig_experimental1;
        isTurboSession = true;
        ...
        const { pagesDir , appDir  } = (0, _findpagesdir.findPagesDir)(dir, !!((_rawNextConfig_experimental = rawNextConfig.experimental) == null ? void 0 : _rawNextConfig_experimental.appDir));
        ...
        let server = bindings.turbo.startDev({
            ...
            root: args["--root"] ?? ((_rawNextConfig_experimental1 = rawNextConfig.experimental) == null ? void 0 : _rawNextConfig_experimental1.outputFileTracingRoot)
        });
