...
class Server {
   ...
   */ async prepare() {
    ...
    async renderToResponseWithComponentsImpl({ req , res , pathname , renderOpts: opts  }, { components , query  }) {
        ...
        const isFlightRequest = Boolean(this.clientReferenceManifest && req.headers[_approuterheaders.RSC.toLowerCase()]);
                ...
                try {
                    ...
                    if (response) {
                        ...
                        if (isSSG && process.env.NEXT_RUNTIME !== "edge") {
                            ...
                            const headers = (0, _utils3.toNodeHeaders)(response.headers);
                            if (cacheTags) {
                    ...
                    if (match.definition.kind === _routekind.RouteKind.APP_ROUTE) {
        ...
        if (!cachedData) {
            ...
            await (0, _sendresponse.sendResponse)(req, res, new Response(cachedData.body, {
                headers: (0, _utils3.fromNodeHeaders)(headers),
